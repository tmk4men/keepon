...
// 家でできる（道具不要・室内）メニュー。目的×運動量ごとに用意し、
// pickNormalMenus で全バケツの候補に混ぜる。
const HOME_MENUS: Record<Goal, Record<Capacity, Menu[]>> = {
  diet: {
    low: [
      n('d-home-l1', '部屋で軽サーキット 8分', 'スクワット・もも上げ・足踏みを各40秒。家の中だけで完結。', 8),
      n('d-home-l2', 'ながらストレッチ＆スクワット 10分', 'テレビを見ながら、スクワット10回×2＋全身ストレッチ。', 10),
      n('d-home-l3', '床トレ 10分', 'ヒップリフト・プランク・腹筋を各2セット。マット1枚分のスペースで。', 10),
    ],
    mid: [
      n('d-home-m1', 'おうちHIIT 15分', 'もも上げ・スクワット・腕立てを20秒全力／40秒休憩。マンションでも静かにできる版でOK。', 15),
      n('d-home-m2', '自重サーキット 18分', 'スクワット・腕立て・バックランジ・プランクを各40秒×4周。', 18),
      n('d-home-m3', 'リビング有酸素 15分', 'その場もも上げ・サイドステップ・シャドーボクシングをテンポよく。', 15),
    ],
    high: [
      n('d-home-h1', 'おうち全身バーン 25分', 'バーピー・ジャンプスクワット・マウンテンクライマーを部屋で5周。', 25),
      n('d-home-h2', '自重HIIT 20分', '全力20秒／休憩40秒を全身種目で。道具なし・外に出ずに追い込む。', 20),
      n('d-home-h3', '部屋でフルボディサーキット 28分', '上半身・下半身・体幹をローテーション。休憩短めで密度高く。', 28),
    ],
  },
  bulk: {
    low: [
      n('b-home-l1', '自重ベーシック 10分', '腕立て・スクワット・プランクを各2セット。これぞ家トレの基本。', 10),
      n('b-home-l2', '床トレ筋トレ 10分', 'ヒップリフト・バードドッグ・腹筋を各2セット。', 10),
      n('b-home-l3', 'イスを使った筋トレ 10分', 'イスでディップス・ブルガリアン風スクワットを各10回×2。', 10),
    ],
    mid: [
      n('b-home-m1', 'おうち上下分割 18分', '自重で上半身（腕立て・肩）→下半身（スクワット・ランジ）を各3セット。', 18),
      n('b-home-m2', '自重しっかりサーキット 16分', 'プッシュ・スクワット・ヒップリフト・プランクを各45秒×4周。', 16),
      n('b-home-m3', 'リュックで加重トレ 18分', '本を入れたリュックを背負ってスクワット・ローイング・カーフ。', 18),
    ],
    high: [
      n('b-home-h1', 'おうち高負荷自重 28分', '片足スクワット・足上げ腕立て・パイクプッシュアップで自重でも高強度。', 28),
      n('b-home-h2', 'リュック加重フルボディ 25分', '加重リュックでスクワット・ランジ・ローイング・プレスを3〜4セット。', 25),
      n('b-home-h3', '自重追い込みサーキット 30分', '休憩を短くして全身種目を回す。道具なしで限界手前まで。', 30),
    ],
  },
}

// 低負荷（ひざ・腰にやさしい）メニュー。BMIが高めのとき、通常メニューの代わりに提示する。
// ジャンプ・走り込みなど着地衝撃の大きい種目は外し、関節への負担を抑えている。
const LOW_IMPACT: Record<Goal, Menu[]> = {
  diet: [
    n('d-li-1', 'フラット早歩き 15分', '平らな道を、息が少し弾むペースで。着地の衝撃が少なく続けやすい。', 15),
    n('d-li-2', 'イスエクササイズ 12分', 'イスに座って・支えにして、もも上げ・足の開閉・上体ひねりを各2周。', 12),
    n('d-li-3', '寝てできる下半身 10分', 'ヒップリフト・あお向け足上げ・横向き脚上げを各2周。ひざに体重をかけない。', 10),
    n('d-li-4', 'エアロバイク／自転車 18分', '一定ペースでこぐだけ。関節にやさしく脂肪燃焼を狙える。なければ早歩きで代用。', 18),
    n('d-li-5', '体幹ドローイン 10分', 'プランク20秒・ドローイン・バードドッグを各2周。お腹まわりを静かに使う。', 10),
    n('d-li-6', '水中ウォーク 15分', 'プールがあれば、浮力で関節を守りながら歩く。なければフラット早歩きで。', 15),
  ],
  bulk: [
    n('b-li-1', 'イス補助スクワット 12分', 'イスに軽く触れながらゆっくりスクワット12回×3。バランスを気にせず効かせる。', 12),
    n('b-li-2', '床トレ下半身 12分', 'ヒップリフト・あお向けレッグカール・横脚上げを各12回×2〜3。', 12),
    n('b-li-3', '座って上半身ダンベル 15分', 'イスに座ってカール・プレス・サイドレイズを各12回×3。下半身に負担をかけない。', 15),
    n('b-li-4', '壁・ひざつき腕立て 10分', '壁orひざつきで腕立て10回×3。手首がつらければ壁の角度を立てる。', 10),
    n('b-li-5', 'コア集中 12分', 'プランク・サイドプランク・デッドバグを各2〜3周。体幹の土台を太くする。', 12),
    n('b-li-6', 'ゴムバンド全身 15分', 'バンドでローイング・プレス・アブダクションを各15回×2〜3。関節へやさしく筋肉に効く。', 15),
  ],
}
...
export function pickNormalMenus(
  ...
  // BMIが高めのときは、関節にやさしい低負荷メニューだけから出す。
  if (jointCare) {
    const pool = [...LOW_IMPACT[goal], ...HOME_MENUS[goal].low]
    return rotatePair(pool, dayIndex)
  }
  // 週4回以上は分割型、週3回以下は全身まとめ型のメニューを候補に混ぜる。
  // さらに家でできる（道具不要）メニューも候補に加える。
  const band = frequency >= 4 ? 'split' : 'spread'
  const pool = [
    ...NORMAL[goal][capacity][gender],
    ...FREQ_FLAVOR[goal][band],
    ...HOME_MENUS[goal][capacity],
  ]
  return rotatePair(pool, dayIndex)
}
